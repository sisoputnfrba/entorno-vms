...
# Fuentes
# xfconf-query -c xsettings -p /Gtk/FontName -s "Sans Regular 10"
# xfconf-query -c xfwm4 -p /general/title_font -n -t string -s "Sans Bold 10"
# xfconf-query -c xsettings -p /Gtk/MonospaceFontName -s "Monospace Regular 11"
